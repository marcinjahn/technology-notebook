...
The website is built using [Astro](https://astro.build). It's a great
...
In the past, I relied on [VuePress](https://vuepress.vuejs.org/).
...
:|). Since a website that is accessible a bit randomly is not what I wanted, I
...
Pages](https://pages.github.com/). I have a separate GitHub Actions workflow
defined that automatically builds the artifacts from the *main* branch.
