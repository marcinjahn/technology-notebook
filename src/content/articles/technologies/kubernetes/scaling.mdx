...
import deploymentReplicasetSelector from '../../../../assets/deployment-replicaset-selector.png';
...
`selector` (similarly to [Services](/technologies/kubernetes/services)). There
is also a `template`, which defines the pod(s) that will be created under
...
<Image src={deploymentReplicasetSelector} alt=""/>
:::
