...
Enable multithreaded socket connections for better stability.

## Installing Zigbee2MQTT

- [GitHub Installation Guide](https://github.com/zigbee2mqtt/hassio-zigbee2mqtt#installation)
- [Connecting to HA MQTT Broker](https://atmotube.com/atmocube-support/integrating-home-assistant-via-mqtt)
- [MQTT5 Explorer](https://github.com/Omniaevo/mqtt5-explorer) is an awesome app to monitor MQTT traffic, it autodiscovers topics.
