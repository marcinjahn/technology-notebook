...
concatenated with a [digest](/technologies/secruity/tpm/basic-terms#hash) M. It's called a
**folding-hash**.
...
the user for storage. They aren't considered _Objects_ due to having more
