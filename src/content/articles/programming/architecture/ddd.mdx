...
lang: en-US
tags: ["architecture", "ddd", "domain driven design", "bounded context", "microservices", "ubiquitous language", "context map", "domain model", "entities", "aggregation", "aggregation root", "integtation event", "eric evans", "repository", "domain event", ".net", "dotnet", "asp.net", "asp", "core"]
---
