...
2. CPU Caches
   1. L1 - the fastest layer of cache (<2ns), lowest capacity
...
- memory can be constrained or extended above the RAM capacity (via swap for example).
...
address would be bad on performance.
