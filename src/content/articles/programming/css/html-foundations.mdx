...
our document semantically reach will most likely improve the experience for all user agents types.
...
- L - Language - it is a language, that is it has consistent vocabulary for its markup. It has a
  specification.
