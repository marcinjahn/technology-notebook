...
One of the units that we can use in CSS is a `px`. The name is confusing
...
engines to render absolute sizes correctly, according to physical
dimensions. However, many implementations did not follow that and W3C
eventually dropped that requirement
([source](https://www.w3.org/Style/Examples/007/units.en.html)).

It is important because it means that our current web pages that have sizes
