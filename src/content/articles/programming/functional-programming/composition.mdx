...
import layeredCode from '../../../../assets/layered-code.png';
import nonLayeredCode from '../../../../assets/non-layered-code.png';
...
<Image src={layeredCode} alt=""/>

In FP, it should look more like this:

<Image src={nonLayeredCode} alt=""/>
