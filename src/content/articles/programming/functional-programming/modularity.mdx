...
The code above is an example of [Partial
Application](/programming/functional-programming/partial-application/). In order
to save the transfer, three parameters are required:
- validator
- saver
- request details
