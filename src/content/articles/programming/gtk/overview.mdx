...
tags: ["gtk", "gobject", "glib", "libadwaita", "gjs", "linux", "binding"]
lang: en-US
---
...
GTK is a toolkit for creating GUI apps, mostly targeting Linux systems and the
...
The popularity of GTK app development would certainly benefit from more materials
...
- [Gnome Developer Portal](https://developer.gnome.org/) - a documentation and
  guides for developing apps for the Gnome Platform.
