...
- it's a good idea to use [Renderer2](./tips#renderer2).
...
[references](./tips#references-to-html-elements) or
[Renderer2](./tips#renderer2). It's a decorator called `HostBinding`. It
...
:::tip[Renderer2]
There's nothing wrong with using [Renderer2](./tips#renderer2). It's just
