...
Providing a service in ANY [eager-loaded module](./modules#lazy-loading)
(e.g., `AppModule`), makes it a **global singleton** (for both all the components
and services). T

Providing a service in a [lazy-loaded module](./modules#lazy-loading), makes
...
This method cannot be used with [interceptors](./http#interceptors).
