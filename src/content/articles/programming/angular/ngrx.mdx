...
use a [Router](./routing) to redirect the user somewhere else. To do that,
...
[RxJs](./observables) operator. It joins the original observable with data
...
addition that emits [actions](#actions) based on [Router](./routing)'s
