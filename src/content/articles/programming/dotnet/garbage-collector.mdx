...
objects that are unreachable form applicaton root.
...
- **Gen 2** - for long-lived objects that have stayed alive after a few Gen 1
  ...
  live throught the whole lifetime of an app.
...
hundred, or a thousand, depending on your needs), and request/return object
...
- shouldn't be used to allocate too much stafe, otherwise stack overflow will occur
